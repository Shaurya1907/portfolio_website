...
const About = () => {
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText('shauryagoyal1907@gmail.com');
      ...
      <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5">
        ...
        <div className="col-span-1 xl:row-span-3">
            <div className="grid-container">
                ...
                <div>
                    ...
                    <p className="grid-subtext">I specialize in C/C++, OpenGL, SFML, UE5, and GameDev.</p>
                </div>
            </div>
        </div>
        ...
        <div className="xl:col-span-2 xl:row-span-3">
            <div className="grid-container">
                ...
                <div>
                    <p className="grid-headtext">My Passion for making Video Games</p>
                    <p className="grid-subtext">I love making games, solving problems and building things through code. Coding isn't my profession - it is my passion.</p>
                </div>
            </div>
        </div>
            ...
            <div className="grid-container">
                ...
                <div className="space-y-2">
                    ...
                    <div className="copy-container" onClick={handleCopy}>
                        ...
                        <p className="lg:text-1.5xl md:text-xl font-medium text-gray_gradient text-white">shauryagoyal1907@gmail.com</p>
                    </div>
                </div>
            </div>
        </div>
